...
<br><div class="text-center">
                <div class="header">
    		 <div class="p-3 mb-2 bg-primary text-white"><h1>DELETE RECORD</h1></div>
  		</div>
				...
				<?php
					while($row=$result->fetch_assoc()):?>
						...
						<tr>
							...
							<td>
								<a href="process.php?delete=<?php echo $row['id'];?>" onclick="return  confirm('Are you sure you want to delete?')"
